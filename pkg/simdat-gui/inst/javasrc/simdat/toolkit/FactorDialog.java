...
public class FactorDialog extends JDialog implements ActionListener {
    ...
    private String curEnv = SimDat.guiEnv;

    public FactorDialog(JFrame frame, String modName, String var) {
        super(frame);
        rModelName = modName;
        variable = var;
        initGUI();
    ...
    public FactorDialog(JFrame frame, String modName, String var, String curEnv) {
        super(frame);
        rModelName = modName;
        this.curEnv = curEnv;
        variable = var;
    ...
    public FactorDialog(Window frame, String modName, String var, String curEnv) {
        super(frame);
        rModelName = modName;
        this.curEnv = curEnv;
        variable = var;
    ...
    private void initGUI() {
        try {
            ...
            REXP tmp = SimDat.eval("is.ordered(getData("+rModelName+")$"+variable+")");
            ...
            }
            {
                ...
                listPanel.setPreferredSize(new java.awt.Dimension(197, 190));
                {
                    ...
                    listPanel.add(levelScroller, BorderLayout.CENTER);
                    {
                        ...
                        String[] levels = SimDat.eval("levels(getData(" + rModelName + ")$" + variable + ")", curEnv).asStrings();
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (cmd == "Up") {
             ...
             *
             */
            REXPInteger varID = (REXPInteger) SimDat.eval("which(variableNames(" + rModelName + ") == '" + variable + "')", curEnv);
            String call = "levels(variables(" + rModelName + ")[[" + varID.asIntegers()[0] + "]]) <- " + rLevels;
            if (cntr != null) {
