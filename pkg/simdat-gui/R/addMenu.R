menuFunctions<-(function(){
			...
			return(list(simdat.getmenus=getMenus,
							simdat.setmenus=setMenus,
							simdat.addmenu=addMenu,
							simdat.addMenuItem=addMenuItem))
})()

simdat.getMenus <- menuFunctions[["simdat.getmenus"]]
simdat.setMenus <- menuFunctions[["simdat.setmenus"]]
simdat.addMenu <- menuFunctions[["simdat.addmenu"]]
simdat.addMenuItem <- menuFunctions[["simdat.addMenuItem"]]
