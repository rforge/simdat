...
//import simdat.toolkit.HelpButton;
...
public class Wizard extends WindowAdapter implements PropertyChangeListener {
   ...
   /**
    ...
    public String getHelpUrl(){
        String value = wizardModel.getHelpUrl();
        return(value);
    }
    ...
    private void initComponents() {
        ...
        //backButton = new JButton(new ImageIcon("simdat/wizards/backIcon.gif"));
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("simdat.wizards.Wizard");
    ...
    static {
        ...
        try { 
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                ResourceBundle.getBundle("simdat.wizards.wizard");
            ...
            HELP_TEXT = (String)(resources.getObject("helpButtonText"));
            ...
            HELP_ICON = new ImageIcon((URL)getImage((String)(resources.getObject("helpButtonIcon"))));
